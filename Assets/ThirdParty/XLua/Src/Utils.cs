...
namespace XLua
{
	...
	public static partial class Utils
	{
        ...
        public static RealStatePtr LuaL {
            get {
                return Lua.L;
            }
        }

        public static ObjectTranslator ObjTranslator {
            get {
                return Lua.translator;
            }
        }

        public static object GetObject(RealStatePtr L, int index)
        {
            return ObjTranslator.GetObject(L, index);
        }
