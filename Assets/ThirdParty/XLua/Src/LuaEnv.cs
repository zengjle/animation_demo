    ...
    public class LuaEnv : IDisposable
    {
        ...
        private string init_xlua = @"
            ...
            Types = {
                ...
                Vector2s = {'UnityEngine.Vector2[]'},
                Vector3 = {'UnityEngine.Vector3'},
                Vector3s = {'UnityEngine.Vector3[]'},
                Color = {'UnityEngine.Color'},
                Colors = {'UnityEngine.Color[]'},
                Image = {'UnityEngine.UI.Image'},
                Images = {'UnityEngine.UI.Image[]'},
                RawImage = {'UnityEngine.UI.RawImage'},
                RawImages = {'UnityEngine.UI.RawImage[]'},
                Camera = {'UnityEngine.Camera'},
                Cameras = {'UnityEngine.Camera[]'},
                Sprite = {'UnityEngine.Sprite'},
                Sprites = {'UnityEngine.Sprite[]'},
                SpriteRenderer = {'UnityEngine.SpriteRenderer'},
                SpriteRenderers = {'UnityEngine.SpriteRenderer[]'},
                Text = {'UnityEngine.UI.Text'},
                Texts = {'UnityEngine.UI.Text[]'},
                Button = {'UnityEngine.UI.Button'},
                Buttons = {'UnityEngine.UI.Button[]'},
                InputField = {'UnityEngine.UI.InputField'},
                Slider = {'UnityEngine.UI.Slider'},
                LuaTarget = {'XLua.LuaTarget'},
                LuaTargets = {'XLua.LuaTarget[]'},
                playableDirector = {'UnityEngine.Playables.playableDirector'}
                -- DOTweenAnimation = {'DG.Tweening.DOTweenAnimation'},
                -- SkeletonAnimation = {'Spine.Unity.SkeletonAnimation'},
                -- AnimationReferenceAsset = {'Spine.Unity.AnimationReferenceAsset'},
                -- AnimationReferenceAssets = {'Spine.Unity.AnimationReferenceAsset[]'},
                -- BehaviorTree = {'BehaviorDesigner.Runtime.BehaviorTree'},
                -- ExternalBehaviorTree = {'BehaviorDesigner.Runtime.ExternalBehaviorTree'},
            }
            ";
        ...
        public static string LuaRelativeDir = "mnRes/Lua";
        private static string luaDir;

        public static string LuaDir {
            get {
                if (luaDir == null)
                {
                    luaDir = UnityEngine.Application.dataPath + "/" + LuaRelativeDir;
                }
